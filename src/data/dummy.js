...
export const EditorData = () => (
  <div>
    <h3>
    It was a very sharp learning curve. At the start of the project we a group of 6 very ambitious students , who unfortunately knew almost nothing about web development, took on this mammoth challenge of not only building but also improving the SLCM (Student Life Cycle Management).
What started off as a joke soon turned out to become one of the biggest headaches we had. It started off with just an idea to improve the student SLCM experience ,and as it always happens one thing led to another and before we knew we had soon committed a little more than we thought was possible. Going to show how confident we were we even named our team GodSquad.
What followed were weeks filled with ideation and repeatedly scrapping of unsuccessful ideas / methods to implement this project. Starting off with building the entire website with HTML, CSS, JavaScript with PHP and mySQL as the backend, we soon scrapped the idea. What followed was a an idea to build it on python but that was unsuccessful as well.
After numerous failed concepts we finally settled with using HTML , CSS, JS and React JS for the frontend and firebase which provides NoSQL and real time hosting of database for the backend.
Finally after hours of continuous coding, working as a team to build BetterSLCM we were able to use the skills of teamwork, pressure management, time management that we developed along the way along with technical skills such as learning completely new coding languages such as React JS, we surely enchanced our ability, both technical and non technical. 
    </h3>
  </div>
);
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Arihant Joined the Team!',
  ...
  },
  {
    ...
    desc: 'Anant sent you new message',
    time: '11:56 AM',
  },
  {
    image:
      avatar,
    message: 'Shreyas has updated kanban',
...
export const earningData = [
  {
    ...
    amount: '83/100',
    percentage: '83%',
    title: 'Mathematical Foundations for Data Science - III',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'red-600',
  },
  {
    icon: <TbIcons.TbMessageLanguage />,
    amount: '90/100',
    percentage: '90%',
...
export const lineChartData = [
  [
    { x: new Date(2022, 1, 1), y: 21 },
    { x: new Date(2022, 2, 1), y: 24 },
    { x: new Date(2022, 3, 1), y: 36 },
    { x: new Date(2022, 4, 1), y: 38 },
    { x: new Date(2022, 5, 1), y: 54 },
    { x: new Date(2022, 6, 1), y: 57 },
    { x: new Date(2022, 7, 1), y: 70 },
    { x: new Date(2022, 8, 1), y: 54 },
    { x: new Date(2022, 9, 1), y: 57 },
    { x: new Date(2022, 10, 1), y: 70 },
    { x: new Date(2022, 11, 1), y: 54 },
    { x: new Date(2022, 12, 1), y: 57 },
  ],
  [
    { x: new Date(2022, 1, 1), y: 28 },
    { x: new Date(2022, 2, 1), y: 44 },
    { x: new Date(2022, 3, 1), y: 48 },
    { x: new Date(2022, 4, 1), y: 50 },
    { x: new Date(2022, 5, 1), y: 66 },
    { x: new Date(2022, 6, 1), y: 78 },
    { x: new Date(2022, 7, 1), y: 84 },
    { x: new Date(2022, 8, 1), y: 66 },
    { x: new Date(2022, 9, 1), y: 78 },
    { x: new Date(2022, 10, 1), y: 84 },
    { x: new Date(2022, 11, 1), y: 66 },
    { x: new Date(2022, 12, 1), y: 78 },
  ],

  [
    { x: new Date(2022, 1, 1), y: 10 },
    { x: new Date(2022, 2, 1), y: 20 },
    { x: new Date(2022, 3, 1), y: 30 },
    { x: new Date(2022, 4, 1), y: 39 },
    { x: new Date(2022, 5, 1), y: 50 },
    { x: new Date(2022, 6, 1), y: 70 },
    { x: new Date(2022, 7, 1), y: 100 },
    { x: new Date(2022, 8, 1), y: 50 },
    { x: new Date(2022, 9, 1), y: 70 },
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Analyze the problem statement',
    Type: 'Story',
    Priority: 'Low',
  ...
  },
  {
    ...
    Title: 'Task - 29002',
    Status: 'InProgress',
    Summary: 'Make a pipeline for frontend and backend',
    Type: 'Improvement',
    Priority: 'Normal',
    Tags: 'Improvement',
    Estimate: 6,
  ...
  },
  {
    ...
    Title: 'Task - 29003',
    Status: 'Open',
    Summary: 'Get a meeting with the group to further discuss',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29018',
    Status: 'Close',
    Summary: 'Analyze NoSQL server connection on Firestore.',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Grid,Sql',
    Estimate: 2,
  ...
  },
  {
    ...
    Title: 'Task - 29030',
    Status: 'Testing',
    Summary: 'Fix the issues reported by Firebase.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'Customer',
    Estimate: '3.5',
  ...
  },
  {
    ...
    Title: 'Task - 29031',
    Status: 'Testing',
    Summary: 'Fix the issues reported Node.js.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'Fix,Safari',
    Estimate: 1.5,
